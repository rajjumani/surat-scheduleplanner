...
if(isset($_POST["login"])){
    ...
    else
    {
        ...
        $result = $db_handle->numRows("SELECT * FROM users WHERE username='$username' and password='$password'");
                                    ...
                                    <div class="widget-main">
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="clearfix">
                                                ...
                                                <button type="submit" class="width-35 pull-right btn btn-sm btn-primary"name="login" id="login" value="login">
