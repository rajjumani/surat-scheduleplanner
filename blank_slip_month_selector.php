...
?>
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<form class="form-horizontal" role="form" name="master_form" action="blank_slip.php" method="post">				
				...
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> No of Slips: </label>

					<div class="col-sm-9">
						<input type="text" name="slip_count" id="slip_count" class="col-ms-2"/>
					</div>
				</div>
