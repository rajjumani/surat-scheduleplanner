				...
				if (strcmp($sr[0], "SR") == 0) {
					...
					for ($row = 1; $row <= 3; $row++) 
					{
						...
						for ($col=1; $col <= 4; $col++) {
							...
							{
								if ($col ==1) {
									$table_str .= '<th colspan = 3 width = "60%">'."SATSANG READER SEWA SLIP".'</th>';
									$col++;
								}
								elseif ($col ==3) {
							...
							elseif ($row == 2) 
							{
								$table_str .= '<th colspan = 4 width = "100%">'."Name: ".$sr[1].'</th>';
								break;
							}
							...
							elseif ($row == 3) 
							{
								...
								elseif ($col ==4) {
									$table_str .= '<th width = "35%">'."PATHI & SATSANG".'</th>';
								}
							}
						}
					...
					foreach ($weekdays as $date => $day) {
						...
						$table_str .= "'".$day."'";
						$table_str .= ")";
						$table_str .= '" onClick="showEdit(this)">'.$pathi." ".$satsang_no.'</td>';*/
